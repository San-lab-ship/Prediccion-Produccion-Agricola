...
## 📋 Descripción
Este proyecto tiene como objetivo **predecir la producción agrícola** (café y frutas) para mejorar la logística, planificación de cosechas y exportación.  
Se utilizan **datos históricos de producción, variables climáticas, fertilización y tipo de suelo**, combinados con técnicas de **Machine Learning** y **Big Data** para generar predicciones precisas y confiables.

El proyecto permite a los empresarios visualizar resultados de manera clara, con métricas traducidas a **porcentajes y niveles de eficiencia**, facilitando la toma de decisiones estratégicas.

---

## 🌾 Industria
- **Agroindustria**: cafetera y frutícola.  
- **Aplicación**: optimización logística, planificación de cosechas, reducción de pérdidas y proyección de exportaciones.
...
## 📊 Dataset
- Producción histórica de cultivos.  
- Datos climáticos: temperatura, precipitación, humedad, radiación solar.  
- Fertilización y manejo del suelo.  
- Tipo y calidad de suelo.  

> Nota: Los datos pueden ser simulados o provistos por la empresa según disponibilidad.
...
| Métrica               | Valor   | Interpretación Empresarial                       |
|-----------------------|---------|-------------------------------------------------|
| **MAPE**              | 7.88%   | Error medio de predicción bajo, alta precisión |
| **SMAPE**             | 7.89%   | Error porcentual simétrico bajo                |
| **Accuracy ±10%**     | 63.00%  | 63% de las predicciones están dentro ±10%     |
| **R² (%)**            | 93.87%  | Modelo explica casi 94% de la variabilidad    |
...
📈 Comparación Producción Real vs Predicha
📉 Distribución de Errores de Predicción
📅 Tendencias de Producción por Temporada
🏞️ Producción Promedio por Región
🍎 Producción Promedio por Cultivo
🗺️ Mapa de Rendimiento por Parcela (Estático)
📦 Boxplots de Producción por Región
📦 Boxplots de Producción por Cultivo
🔗 Correlaciones entre Variables Climáticas y Producción
